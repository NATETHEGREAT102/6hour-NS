...
#8. Create a list and put inside the months you DIDN'T add append in #6.

#9. Make a loop that calculates the first 10 numbers of the Fibonacci sequence.

#10. Create a loop that can work at room temperature so that cold fusion occurs.
